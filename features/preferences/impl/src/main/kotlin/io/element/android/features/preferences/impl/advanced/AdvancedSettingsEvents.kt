...
sealed interface AdvancedSettingsEvents {
    ...
    data class SetRenderRedactedMessagesEnabled(val enabled: Boolean) : AdvancedSettingsEvents
    data class SetMarkdownEnabled(val enabled: Boolean) : AdvancedSettingsEvents
    data class SetHideSpaceRooms(val hide: Boolean) : AdvancedSettingsEvents
